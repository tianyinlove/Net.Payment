...
namespace Alipay.AspNetCore
{
    ...
    public interface IAopClient
    {
        ...
        /// <returns>响应参数对象</returns>
        Task<T> ExecuteAsync<T>(IAopRequest<T> request, string accessToken, string appAuthToken, string targetAppId) where T : AopResponse;
        ...
        /// <param name="request">请求参数对象</param>
        /// <returns>响应参数对象</returns>
        Task<T> CertificateExecute<T>(IAopRequest<T> request) where T : AopResponse;
        ...
        /// <param name="accessToken">用户授权token</param>
        /// <returns>响应参数对象</returns>
        Task<T> CertificateExecute<T>(IAopRequest<T> request, string accessToken) where T : AopResponse;
        ...
        /// <param name="appAuthToken">三方应用授权token</param>
        /// <returns>响应参数对象</returns>
        Task<T> CertificateExecute<T>(IAopRequest<T> request, string accessToken, string appAuthToken) where T : AopResponse;
        ...
        /// <param name="targetAppId">目标AppId，调用SPI三方能力API时需要传递此参数</param>
        /// <returns>响应参数对象</returns>
        Task<T> CertificateExecute<T>(IAopRequest<T> request, string accessToken, string appAuthToken, string targetAppId) where T : AopResponse;
        ...
        Task<T> PageExecute<T>(IAopRequest<T> request) where T : AopResponse;
        ...
        /// <returns>领域对象</returns>
        Task<T> PageExecute<T>(IAopRequest<T> request, string accessToken, string reqMethod) where T : AopResponse;
        ...
        /// <param name="reqMethod">请求方式,两个值可选：POST、GET;</param>
        /// <returns>领域对象</returns>
        Task<T> PageExecute<T>(IAopRequest<T> request, string accessToken, string appAuthToken, string reqMethod) where T : AopResponse;
