...
namespace Net.Alipay.Parser
{
    ...
    public class AopXmlParser<T> : IAopParser<T> where T : AopResponse
    {
        ...
        private static string GetSign(string body)
        {
            ...
            int indexOfSignNode = body.IndexOf(signNodeName, System.StringComparison.Ordinal);
            int indexOfSignEndNode = body.IndexOf(signEndNodeName, System.StringComparison.Ordinal);
        ...
        private static string GetSignSourceData(IAopRequest<T> request, string body)
        {
            ...
            int indexOfRootNode = body.IndexOf(rootNode, System.StringComparison.Ordinal);
            int indexOfErrorRoot = body.IndexOf(errorRootNode, System.StringComparison.Ordinal);
        ...
        private static string GetCertSN(string body)
        {
