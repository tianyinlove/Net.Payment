...
namespace Net.Alipay.Util
{
    ...
    public sealed class WebUtils
    {
        ...
        /// <param name="charset">编码字符集</param>
        /// <returns>HTTP响应</returns>
        public async Task<string> DoGet(string url, IDictionary<string, string> parameters, string charset)
        {
        ...
        /// <param name="charset">编码字符集</param>
        /// <returns>HTTP响应</returns>
        public async Task<string> DoPostAsync(string url, IDictionary<string, string> textParams, IDictionary<string, FileItem> fileParams, string charset)
        {
            // 如果没有文件参数，则走普通POST请求
            ...
            while (textEnum.MoveNext())
            {
                ...
                await reqStream.WriteAsync(itemBoundaryBytes, 0, itemBoundaryBytes.Length);
                await reqStream.WriteAsync(itemBytes, 0, itemBytes.Length);
            }
            ...
            await reqStream.WriteAsync(endBoundaryBytes, 0, endBoundaryBytes.Length);
            reqStream.Close();
