...
namespace Net.Alipay
{
    ...
    /// AOP客户端。
    /// </summary>
    public class AlipayClient : IAopClient
    {
        ...
        public AlipayClient(string serverUrl, string appId, string privateKeyPem)
        {
            this.appId = appId;
        ...
        public AlipayClient(string serverUrl, string appId, string privateKeyPem, bool keyFromFile)
        {
            this.appId = appId;
            this.privateKeyPem = privateKeyPem;
            this.serverUrl = serverUrl;
        ...
        public AlipayClient(string serverUrl, string appId, string privateKeyPem, string format)
        {
            this.appId = appId;
            this.privateKeyPem = privateKeyPem;
            this.serverUrl = serverUrl;
        ...
        public AlipayClient(string serverUrl, string appId, string privateKeyPem, string format, string charset)
        ...
        public AlipayClient(string serverUrl, string appId, string privateKeyPem, string format, string version, string signType)
        ...
        public AlipayClient(string serverUrl, string appId, string privateKeyPem, string format, string version, string signType, string alipayPulicKey)
        ...
        /// <param name="alipayPulicKey"></param>
        /// <param name="charset"></param>
        public AlipayClient(string serverUrl, string appId, string privateKeyPem, string format, string version, string signType, string alipayPulicKey, string charset)
        ...
        /// <param name="charset"></param>
        /// <param name="keyFromFile"></param>
        public AlipayClient(string serverUrl, string appId, string privateKeyPem, string format, string version, string signType, string alipayPulicKey, string charset, bool keyFromFile)
            : this(serverUrl, appId, privateKeyPem, format, version, signType, alipayPulicKey)
        {
            this.keyFromFile = keyFromFile;
            this.charset = charset;
        ...
        public AlipayClient(string serverUrl, string appId, string privateKeyPem, string format, string version, string signType, string charset, bool keyFromFile, CertParams certParams)
        ...
        public AlipayClient(string serverUrl, string appId, string privateKeyPem, string format, string version, string signType, string alipayPulicKey, string charset, string encyptKey)
        ...
        /// <param name="encyptKey"></param>
        /// <param name="certParams"></param>
        public AlipayClient(string serverUrl, string appId, string privateKeyPem, string format, string version, string signType, string charset, string encyptKey, CertParams certParams)
